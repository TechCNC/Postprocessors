...
function onSection() {
  ...
  switch (coolant) {
    ...
    case COOLANT_FLOOD:
      ...
      writeBlock("G10", "L80", "P8133", "Q5", "M8"); // включить заливное охлаждение
      break;
    case COOLANT_MIST:
      writeComment("MQL oil amount Q30 ml/h");
      writeBlock("G10", "L80", "P8133", "Q20", "M8"); //увеличиваем кол-ва масла в систему MQL
      break;
    case COOLANT_AIR:
...
function onCyclePoint(x, y, z) {
  ...
  if (isFirstCyclePoint()) {
    ...
    case "deep-drilling":
      ...
      writeBlock("G10", "L80", "P8133", "Q20"); //увеличиваем кол-ва масла в систему MQL
      if (P > 0) {
        expandCyclePoint(x, y, z);
      } else {
        writeBlock(
