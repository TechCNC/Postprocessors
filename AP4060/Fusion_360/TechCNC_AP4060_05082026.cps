...
function onSection() {
  ...
  switch (coolant) {
    ...
    case COOLANT_FLOOD:
      ...
      writeBlock("G10", "L80", "P8133", "Q10", "M8"); // включить заливное охлаждение
      break;
    case COOLANT_MIST:
      writeComment("MQL oil amount Q30 ml/h");
      writeBlock("G10", "L80", "P8133", "Q30", "M8"); //увеличиваем кол-ва масла в систему MQL
      break;
    case COOLANT_AIR:
      writeBlock("M209"); // <<< добавили поддержку Air
      break;
    default:
